...
def main():
    ...
    mm = AR4LfDMiddleware(transform_manager, "start_ar", "/cairo_lfd/model_commands", "/cairo_lfd/lfd_representation", "/constraint_manager", "/constraint_edits", "/cairo_lfd/constraint_update")
    rospy.spin()
