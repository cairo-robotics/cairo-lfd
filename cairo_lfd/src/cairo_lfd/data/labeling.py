"""
The labeling.py module contains a classes that are used to label demonstration data. This generally does not require
...
class ConstraintKeyframeLabeler():
    """
    Constraint-based keyframe labeling class.
    ...
    def _get_keyframe_count_per_group(self, divisor=20):
        ...
        Group 1, in the above example, consists of all the data needed to generate keyframes prior to a transition
        region. The purpose of this function is to calculate how many keyframes each group will to have.
