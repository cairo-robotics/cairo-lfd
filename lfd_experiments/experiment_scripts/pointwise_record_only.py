...
from cairo_lfd.core.record import SawyerPointwiseRecorder
...
def main():
    ...
    ###############################################
    # Configure the Sawyer Pointwise Recorder #
    ###############################################

    rec_settings = configs["settings"]["recording_settings"]
    recorder = SawyerPointwiseRecorder(rec_settings, cclfd.environment, processor_pipeline, publish_constraint_validity=True)
