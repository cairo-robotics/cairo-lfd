...
def main():
    ...
    moveit_interface = SawyerMoveitInterface()
    task_graph_analyzer = TaskGraphAnalyzer(task_graph, moveit_interface)
    ...
    task_graph_analyzer.keyframe_culler(threshold=-2000000)
    ...
    while node_list != []:
        ...
        if free_samples == []:
            ...
            print task_graph.nodes[node]["free_samples"]
